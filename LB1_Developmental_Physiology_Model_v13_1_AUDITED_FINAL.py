"""
LB1 DEVELOPMENTAL PHYSIOLOGY MODEL — VERSION 13.1 AUDITED FINAL
...
V13_REGISTRY.to_csv(os.path.join(BASE,"LB1_v13_1_parameter_registry.csv"),index=False)
...
V13_CORR.to_csv(os.path.join(BASE,"LB1_v13_1_correlation_adjusted_robustness.csv"),index=False)
...
V13_SENS.to_csv(os.path.join(BASE,"LB1_v13_1_global_module_sensitivity.csv"),index=False)
...
V13_ROBUST.to_csv(os.path.join(BASE,"LB1_v13_1_prior_width_robustness.csv"),index=False)
print("\n"+"="*92)
...
V13_COMPONENTS.to_csv(os.path.join(BASE,"LB1_v13_1_best_component_errors.csv"),index=False)
...
plt.tight_layout(); plt.savefig(os.path.join(BASE,"LB1_v13_1_global_module_sensitivity.png"),dpi=300); plt.close()
...
plt.tight_layout(); plt.savefig(os.path.join(BASE,"LB1_v13_1_best_component_errors.png"),dpi=300); plt.close()
...
""")
print("VERSION 13.1 AUDITED FINAL COMPLETE")
